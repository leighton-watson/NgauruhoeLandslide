...
from sara import run_method, save_output_bundle
...
SEARCH_BOX = None
SPATIAL_STEP = 100
# Geometric-spreading exponent in r**(-DECAY_EXPONENT); this is distinct
# from the intrinsic attenuation coefficient used in exp(-attenuation_B * r).
DECAY_EXPONENT = 1.0
STORE_FULL_FIELDS = False

SAVE_OUTPUT = HERE / "Outputs" / "SARA_output.npz"
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("SARA amplitude-decay configuration")
    print("=" * 70)
    ...
    print(
        "Geometric spreading      : "
        f"b = {DECAY_EXPONENT:g} (amplitude proportional to r^-b)"
    )
    print("=" * 70 + "\n")
